...
local rDesyncKey = CreateRow("Desync Keybind")
local bDesyncKey = Instance.new("TextButton", rDesyncKey)
bDesyncKey.Size=UDim2.new(0,60,0,24); bDesyncKey.Position=UDim2.new(1,-70,0.5,-12)
bDesyncKey.BackgroundColor3=Theme.SurfaceHighlight
bDesyncKey.Text=Config.DesyncKey ~= "" and Config.DesyncKey or "NONE"
bDesyncKey.Font=Enum.Font.GothamBold; bDesyncKey.TextColor3=Theme.TextPrimary; bDesyncKey.TextSize=12
Instance.new("UICorner",bDesyncKey).CornerRadius=UDim.new(0,4)
bDesyncKey.MouseButton1Click:Connect(function()
    bDesyncKey.Text="..."; bDesyncKey.TextColor3=Theme.Accent1
    local con; con=UserInputService.InputBegan:Connect(function(inp)
        if inp.UserInputType==Enum.UserInputType.Keyboard then
            Config.DesyncKey=inp.KeyCode.Name; bDesyncKey.Text=inp.KeyCode.Name
            bDesyncKey.TextColor3=Theme.TextPrimary; SaveConfig(); con:Disconnect()
